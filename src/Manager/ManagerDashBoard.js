...
import DailyAttendance from "./DailyAttendance"; // Ensure this component is created
...
import ManagerViewLeave from "./ManagerViewLeave";
import PerformanceReview from "./PerformanceReview";
import PerformanceReport from "./PerformanceReport";
import ExpensesApproval from "./ExpensesApproval";
import PayoutDisbursements from "./PayoutDisbursements";
import LoanApproval from "./LoanApproval";
import AdvanceSalaryApplication from "./AdvanceSalaryApplication";
...
import ManagerSalaryAdvanceStatus from "./ManagerSalaryAdvanceStatus";
import ManagerLoanStatus from "./ManagerLoanStatus";
import ManagerPayslip from "./ManagerPayslip";
import ManagerPayout from "./ManagerPayout";
import ManPowerTable from "./ManPowerTable";
import ManagerTrainingList from './ManagerTrainingList';
...
import ManagerMonthlyAttendance from "./ManagerMonthlyAttendance";
import ManagerMonthlyReport from "./ManagerMonthlyReport";
import Holidays from "../HolidaysList";
import EmpMonthlyAttendanceReport from "./EmpMonthlyAttendanceReport";
...
function ManagerDashboard() {
  ...
  const handlePageChange = (page) => {
    ...
    if (page.includes("Attendance&Leave") || page === "managerattendance" || page === "managermonthlyattendance" || page === "managermonthlyreport" || page === "dailyattendance" || page === "monthlyattendancereport" || page === "empmonthlyattendacereport" || page === "managerattendance" || page === "managerviewleave" || page === "leaveApplication" || page === "holidays") {
