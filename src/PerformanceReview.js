...
function PerformanceReview() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Clear form fields and other fields
      setDate("");
      setEmployeeId("");
      setRole("");
      setFullName("");
      setPerformanceMetrics([]); // Clear performanceMetrics
      setAveragePoints(""); // Clear averagePoints
      setCalculateTotalPoints(""); // Clear calculateTotalPoints
